...
export function pickerFrame(items: PickerItem[], selected: number, query: string, useColor: boolean): string {
...
export async function pickItem(items: PickerItem[], useColor: boolean): Promise<PickerItem | null> {
