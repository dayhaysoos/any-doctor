...
export function scoreHeaderTone(score: { score: number; filesTotal: number; partialScan?: boolean; narrowedScan?: boolean }): string {
  return isEmptyScan(score) || score.partialScan === true || score.narrowedScan === true ? YELLOW : gradeColor(score.score);
}
