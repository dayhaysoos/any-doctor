...
export declare function pickerFrame(title: string, items: PickerItem[], selected: number, query: string, useColor: boolean, notice?: string, chosen?: ReadonlySet<string>): string;
...
export declare function pickItemsOn(env: TtyEnv, items: PickerItem[], useColor: boolean, title?: string): Promise<PickerItem[] | null>;
