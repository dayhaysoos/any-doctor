...
async function cmdVerify(args) {
    ...
    if (parsed.all) {
        ...
        if (parsed.format === 'json')
            console.log(JSON.stringify({ protocolVersion: 1, kind: 'verify-cohort', results: machineResults, crashed, skippedUnsafe }, null, 2));
