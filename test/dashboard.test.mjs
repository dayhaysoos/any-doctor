...
test("tree: each doctor row carries its own score against the same denominator", async () => {
  const { buildItems, buildTree, buildListRows } = await import("../bin/dashboard.js");
  const twoDoctors = [
