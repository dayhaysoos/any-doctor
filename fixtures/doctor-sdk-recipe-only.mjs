...
export const meta={id:'recipe-only',description:'Recipe-only certification control',severity:'warning',checks:[{
 id:'recipe-only-map',description:'Discarded async map',claim:'A native async-map array is discarded',lookalikes:['custom object map'],onUnknown:'skip',reportingUnit:'file',
